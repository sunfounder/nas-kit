...
def ram_info():
    ...
    while 1:
        ...
        if i == 2:
            return list(
                map(lambda x: round(int(x) / 1000, 1),
                    line.split()[1:4]))
